...

{
  ...
  const quizSet2 = shuffle([
    {q: 'このキャラクターの名前は何でしょう？', i: '../image/', c: ['ウサハナ', 'マイメロディ', 'ハナウサ']},
    {q: 'このキャラクターの名前は何でしょう？', i: '../image/', c: ['おさるのもんきち', 'おさるのジョージ', 'おさるのぽんきち']},
    {q: 'このキャラクターの名前は何でしょう？', i: '../image/', c: ['コロコロクリリン', 'ポロポロピロリン', 'メロメロメロリン']},
    {q: 'このキャラクターの名前は何でしょう？', i: '../image/', c: ['ハンギョドン', 'ハンギョジン', 'ハンギョギョン']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/retuko.jpg', c: ['アグレッシブ烈子', 'テンション高子', 'マダガスカル由美子']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/', c: ['タキシードサム', 'おさるのもんきち', 'ポムポムプリン']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/pocha.png', c: ['ポチャッコ', 'ペチャンコ', 'ピチャッコ']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/', c: ['ピアノちゃん', 'ヒツジちゃん', 'オンプちゃん']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/', c: ['あひるのペックル', '', '']},
    {q: 'このキャラクターの名前は何でしょう？', i:'../image/', c: ['ハローミミィ', 'ハローキティ', 'キティちゃん']},
