...

{
  ...
  const quizSet2 = shuffle([
    ...
    {q: 'このキャラクターの名前は何でしょう？', i: 'image/han2.png', c: ['ハンギョドン', 'ハンギョジン', 'ハンギョギョン']},
    ...
    {q: 'このキャラクターの名前は何でしょう？', i:'image/bonbon.png', c: ['ぼんぼんりぼん', 'ぽんぽんりぼん', 'マイメロディ']},
  ]);
